...
# ----------------------- Training -----------------------
    ...
    slice_0 = img_ch_shifted[0,26, :, :]
    slice_1 = img_ch_shifted[0,:, 30, :]
    slice_2 = img_ch_shifted[0,:, :, 16]
    show_slices([slice_0, slice_1, slice_2])
    plt.suptitle("CHANNEL SHIFTED")
    plt.show()

    img_zoom = random_zoom(img, [1.1,1.2])
    slice_0 = img_zoom[0,26, :, :]
    slice_1 = img_zoom[0,:, 30, :]
    slice_2 = img_zoom[0,:, :, 16]
    show_slices([slice_0, slice_1, slice_2])
    plt.suptitle("ZOOMED")
    plt.show()

    img_shifted = random_shift(img, 0.2,0.2,0.2)
    slice_0 = img_shifted[0,26, :, :]
    slice_1 = img_shifted[0,:, 30, :]
    slice_2 = img_shifted[0,:, :, 16]
    show_slices([slice_0, slice_1, slice_2])
    plt.suptitle("SHIFTED")
    plt.show()

    img_shifted = add_gaussian_noise(img, 0.05)
    slice_0 = img_shifted[0,26, :, :]
    slice_1 = img_shifted[0,:, 30, :]
    slice_2 = img_shifted[0,:, :, 16]
    show_slices([slice_0, slice_1, slice_2])
    ...
    img_shifted = gaussian_filter(img)
    slice_0 = img_shifted[0,26, :, :]
    slice_1 = img_shifted[0,:, 30, :]
    slice_2 = img_shifted[0,:, :, 16]
    show_slices([slice_0, slice_1, slice_2])
    ...
    img_shifted = average_filter(img)
    slice_0 = img_shifted[0,26, :, :]
    slice_1 = img_shifted[0,:, 30, :]
    slice_2 = img_shifted[0,:, :, 16]
    show_slices([slice_0, slice_1, slice_2])
